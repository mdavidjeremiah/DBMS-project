      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 text-center space-y-4">
            ...
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Password Reset Successful</h1>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 space-y-6">
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Enter your new password below</p>
          </div>
